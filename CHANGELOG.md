...
- Added `devEngines` field to declare Node 22 and pnpm 11 runtime requirements
- Added husky pre-commit hook with lint-staged for automatic lint and format on staged files
- Added `pnpm audit` to CI pipeline
